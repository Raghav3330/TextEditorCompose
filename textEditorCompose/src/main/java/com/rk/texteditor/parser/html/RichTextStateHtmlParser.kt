...
import com.rk.texteditor.parser.RichTextStateParser
...
internal object RichTextStateHtmlParser : RichTextStateParser<String> {
        ...
        val handler = KsoupHtmlHandler
            ...
            .onOpenTag { name, attributes, _ ->
                ...
                if (name in htmlBlockElements) {
                    ...
                    var paragraphType: _root_ide_package_.com.rk.texteditor.model.RichParagraph.Type = _root_ide_package_.com.rk.texteditor.model.RichParagraph.Type.Default
                    if (name == "li") {
                        skipText = false
                ...
                when (name) {
                    "br" -> {
                        ...
                        val currentRichParagraph = richParagraphList.last()
                        val newParagraph =
                            _root_ide_package_.com.rk.texteditor.model.RichParagraph(paragraphStyle = currentRichParagraph.paragraphStyle)
    ...
    private fun encodeHtmlElementToRichParagraphType(
        ...
        return when (tagName) {
            "ul" -> _root_ide_package_.com.rk.texteditor.model.RichParagraph.Type.UnorderedList
            "ol" -> _root_ide_package_.com.rk.texteditor.model.RichParagraph.Type.OrderedList(1)
            else -> _root_ide_package_.com.rk.texteditor.model.RichParagraph.Type.Default
        }
    }
    ...
    private fun decodeHtmlElementFromRichParagraphType(
        richParagraphType: _root_ide_package_.com.rk.texteditor.model.RichParagraph.Type,
    ): String {
        return when (richParagraphType) {
            is _root_ide_package_.com.rk.texteditor.model.RichParagraph.Type.UnorderedList -> "ul"
            is _root_ide_package_.com.rk.texteditor.model.RichParagraph.Type.OrderedList -> "ol"
            else -> "p"
        }
    }
