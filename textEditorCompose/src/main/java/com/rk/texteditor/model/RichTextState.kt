...
import com.rk.texteditor.parser.html.RichTextStateHtmlParser
...
import com.rk.texteditor.utils.getCommonRichStyle
import com.rk.texteditor.utils.getCommonStyle
...
class RichTextState internal constructor(
    initialRichParagraphList: List<_root_ide_package_.com.rk.texteditor.model.RichParagraph>,
) {
    constructor(): this(listOf(_root_ide_package_.com.rk.texteditor.model.RichParagraph()))

    internal val richParagraphList = mutableStateListOf<_root_ide_package_.com.rk.texteditor.model.RichParagraph>()
    ...
    private var currentAppliedParagraphStyle: ParagraphStyle by mutableStateOf(
        getRichParagraphByTextIndex(textIndex = selection.min - 1)?.paragraphStyle
            ...
            ?: _root_ide_package_.com.rk.texteditor.model.RichParagraph.DefaultParagraphStyle
    )
    ...
    private var currentRichParagraphType: _root_ide_package_.com.rk.texteditor.model.RichParagraph.Type by mutableStateOf(
        getRichParagraphByTextIndex(textIndex = selection.min - 1)?.type
            ?: _root_ide_package_.com.rk.texteditor.model.RichParagraph.Type.Default
    )
        private set

    val isUnorderedList get() = currentRichParagraphType is _root_ide_package_.com.rk.texteditor.model.RichParagraph.Type.UnorderedList
    val isOrderedList get() = currentRichParagraphType is _root_ide_package_.com.rk.texteditor.model.RichParagraph.Type.OrderedList
    ...
    fun toggleUnorderedList() {
        val paragraph = getRichParagraphByTextIndex(selection.min - 1) ?: return
        if (paragraph.type is _root_ide_package_.com.rk.texteditor.model.RichParagraph.Type.UnorderedList) removeUnorderedList()
    ...
    fun addUnorderedList() {
        ...
        if (paragraph.type is _root_ide_package_.com.rk.texteditor.model.RichParagraph.Type.UnorderedList) return
        val paragraphOldStartTextLength = paragraph.type.startText.length
        val type = _root_ide_package_.com.rk.texteditor.model.RichParagraph.Type.UnorderedList
        paragraph.type = type
    ...
    fun removeUnorderedList() {
        ...
        paragraph.type = _root_ide_package_.com.rk.texteditor.model.RichParagraph.Type.Default
    ...
    fun toggleOrderedList() {
        val paragraph = getRichParagraphByTextIndex(selection.min - 1) ?: return
        if (paragraph.type is _root_ide_package_.com.rk.texteditor.model.RichParagraph.Type.OrderedList) removeOrderedList()
        else addOrderedList()
    }

    fun addOrderedList() {
        val paragraph = getRichParagraphByTextIndex(selection.min - 1) ?: return
        if (paragraph.type is _root_ide_package_.com.rk.texteditor.model.RichParagraph.Type.OrderedList) return
        ...
        val orderedListNumber =
            if (previousParagraphType is _root_ide_package_.com.rk.texteditor.model.RichParagraph.Type.OrderedList)
        ...
        val paragraphOldStartTextLength = paragraph.type.startText.length
        val type = _root_ide_package_.com.rk.texteditor.model.RichParagraph.Type.OrderedList(number = orderedListNumber)
        paragraph.type = type
    ...
    fun removeOrderedList() {
        ...
        for (i in (index + 1) .. richParagraphList.lastIndex) {
            ...
            if (currentParagraphType !is _root_ide_package_.com.rk.texteditor.model.RichParagraph.Type.OrderedList) break
            richParagraphList[i].type = _root_ide_package_.com.rk.texteditor.model.RichParagraph.Type.OrderedList(number = i - index)
        }
        ...
        annotatedString = buildAnnotatedString {
            ...
            richParagraphList.fastForEachIndexed { i, richParagraphStyle ->
                ...
                withStyle(richParagraphStyle.paragraphStyle.merge(richParagraphStyle.type.style)) {
                    com.rk.texteditor.utils.append(richParagraphStyle.type.startText)
    ...
    private fun handleAddingCharacters() {
        ...
        if (activeRichSpan != null) {
            ...
            if (richParagraphList.isEmpty()) {
                richParagraphList.add(_root_ide_package_.com.rk.texteditor.model.RichParagraph())
            }
    ...
    private fun handleRemovingCharacters() {
        ...
        if (minRemoveIndex < minParagraphFirstChildMinIndex) {
            ...
            minRichSpan.paragraph.type = _root_ide_package_.com.rk.texteditor.model.RichParagraph.Type.Default
        }
        ...
        if (maxRemoveIndex < maxParagraphFirstChildMinIndex) {
            ...
            maxRichSpan.paragraph.type = _root_ide_package_.com.rk.texteditor.model.RichParagraph.Type.Default
        }
    ...
    private fun adjustOrderedListsNumbers(
        ...
        for (i in (startParagraphIndex)..richParagraphList.lastIndex) {
            ...
            if (currentParagraphType is _root_ide_package_.com.rk.texteditor.model.RichParagraph.Type.OrderedList) {
                currentParagraph.type = _root_ide_package_.com.rk.texteditor.model.RichParagraph.Type.OrderedList(number = number)
            } else break
            number++
        }
    }
    ...
    private fun checkOrderedListsNumbers(
        ...
        if (startParagraphType is _root_ide_package_.com.rk.texteditor.model.RichParagraph.Type.OrderedList) {
    ...
    private fun checkForParagraphs() {
        ...
        while (true) {
            ...
            if (newParagraphType is _root_ide_package_.com.rk.texteditor.model.RichParagraph.Type.OrderedList) {
                adjustOrderedListsNumbers(
     ...
     */
    private fun _root_ide_package_.com.rk.texteditor.model.RichParagraph.slice(
        startIndex: Int,
        richSpan: RichSpan,
    ): _root_ide_package_.com.rk.texteditor.model.RichParagraph {
        val newRichParagraph = _root_ide_package_.com.rk.texteditor.model.RichParagraph(
    ...
    private fun mergeTwoRichParagraphs(
        firstParagraph: _root_ide_package_.com.rk.texteditor.model.RichParagraph,
        secondParagraph: _root_ide_package_.com.rk.texteditor.model.RichParagraph,
    ) {
     ...
     */
    private fun getRichParagraphByTextIndex(textIndex: Int): _root_ide_package_.com.rk.texteditor.model.RichParagraph? {
     ...
     */
    private fun getRichParagraphListByTextRange(searchTextRange: TextRange): List<_root_ide_package_.com.rk.texteditor.model.RichParagraph> {
        if (singleParagraphMode) return richParagraphList.toList()

        var index = 0
        val richParagraphList = mutableListOf<_root_ide_package_.com.rk.texteditor.model.RichParagraph>()
    ...
    fun setText(text: String) {
        val richParagraphList = listOf(_root_ide_package_.com.rk.texteditor.model.RichParagraph())
     ...
     */
    private fun updateRichParagraphList(newRichParagraphList: List<_root_ide_package_.com.rk.texteditor.model.RichParagraph>) {
    ...
    private fun checkParagraphsType() {
        ...
        richParagraphList.fastForEachIndexed { _, richParagraph ->
            if (richParagraph.type is _root_ide_package_.com.rk.texteditor.model.RichParagraph.Type.OrderedList) {
                orderedListNumber++
                richParagraph.type = _root_ide_package_.com.rk.texteditor.model.RichParagraph.Type.OrderedList(orderedListNumber)
            } else {
                orderedListNumber = 0
            }
        }
